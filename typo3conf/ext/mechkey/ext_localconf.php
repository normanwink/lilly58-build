	...
	'mod {
		wizards.newContentElement.wizardItems {
          ...
          hero {
            ...
            title = LLL:EXT:mechkey/Resources/Private/Language/locallang_db.xlf:ce.hero.title
            description = LLL:EXT:mechkey/Resources/Private/Language/locallang_db.xlf:ce.hero.description
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPageTSConfig(
    ...
    web_layout {
			BackendLayouts {
				default {
					title = LLL:EXT:mechkey/Resources/Private/Language/locallang_db.xlf:layouts.default
					config {
						backend_layout {
							colCount = 1
							rowCount = 1
							rows {
								1 {
									columns {
										1 {
											name = LLL:EXT:mechkey/Resources/Private/Language/locallang_db.xlf:layouts.default
											colPos = 0
										}
									}
								}
				...
				home {
					title = LLL:EXT:mechkey/Resources/Private/Language/locallang_db.xlf:layouts.home
					config {
						backend_layout {
							colCount = 0
							rowCount = 0
